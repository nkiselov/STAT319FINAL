...
This dataset covers the corn yield and nitrogen fertilizer treatment with field characteristics from the Las Rosas farm in Rio Cuarto, Cordoba, Argentina.  In it, data was collected using yield monitor during the harvests in years 1999 and 2001 to determine the potential of spatial econometric analysis in estimating the crop response functions when it comes to applying nitrogen to corn production.  There are 3443 operations and 8 variables.
